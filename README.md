...
| `babysit` | Canonical PR workflow: publish ready-for-review, watch verification, and fix bounded automated findings. | Explicit draft-only and watch-only exceptions. Caps corrective pushes at 3. Never force-pushes. |
